...
const EditServerModal = () => {
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-white text-black p-0 dark:bg-[#313338] dark:text-gray-100 overflow-hidden">
            ...
            <div className="space-y-8 px-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel
                      className="uppercase text-xs font-bold text-zinc-500 dark:text-gray-300"
                    >
                      Server name
                    </FormLabel>
                    <FormControl>
